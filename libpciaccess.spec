...
Source0  : https://www.x.org/releases/individual/lib/libpciaccess-0.18.tar.xz
Source1  : https://www.x.org/releases/individual/lib/libpciaccess-0.18.tar.xz.sig
...
%prep
%setup -q -n libpciaccess-0.18
cd %{_builddir}/libpciaccess-0.18
pushd ..
cp -a libpciaccess-0.18 build32
popd
pushd ..
cp -a libpciaccess-0.18 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707157975
